...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (findError) {
      logServerError("admin/restore-agent find", findError);
    ...
    if (updateError) {
      logServerError("admin/restore-agent update", updateError);
      return sendError(res, 500, "Unable to restore agent.");
    }
    ...
    logServerError("admin/restore-agent", error);
    return sendError(res, 500, "Unable to restore agent.");
  }
};
